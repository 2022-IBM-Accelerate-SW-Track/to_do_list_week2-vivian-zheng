...
class Home extends Component {
  ...
  addTodo = (todo) => {
    ...
    // Go through each of the todos in the todos list
    // Compare the content of each todo currently in the list (t) with the content of the todo wanting to be added (passed in as a parameter)
